...
import 'l01_sign_in_page_model.dart';
export 'l01_sign_in_page_model.dart';

class L01SignInPageWidget extends StatefulWidget {
  const L01SignInPageWidget({super.key});

  static String routeName = 'L01_SignIn_Page';
  static String routePath = '/l01SignInPage';

  @override
  State<L01SignInPageWidget> createState() => _L01SignInPageWidgetState();
}

class _L01SignInPageWidgetState extends State<L01SignInPageWidget>
    with TickerProviderStateMixin {
  late L01SignInPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => L01SignInPageModel());
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Log in to start your diagnosis Journey',
                                      textAlign: TextAlign.start,
                                      maxLines: 1,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                          L03ForgetPasswordWidget.routeName);
                                    },
                                    child: Text(
                                      'Forgot password?',
                                      textAlign: TextAlign.end,
