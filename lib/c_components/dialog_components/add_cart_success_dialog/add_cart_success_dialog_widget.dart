...
class AddCartSuccessDialogWidget extends StatefulWidget {
  const AddCartSuccessDialogWidget({super.key});

  @override
  State<AddCartSuccessDialogWidget> createState() =>
      _AddCartSuccessDialogWidgetState();
}

class _AddCartSuccessDialogWidgetState
    extends State<AddCartSuccessDialogWidget> {
  late AddCartSuccessDialogModel _model;
