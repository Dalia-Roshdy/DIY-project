...
import 'delete_cart_item_dialog_model.dart';
export 'delete_cart_item_dialog_model.dart';

class DeleteCartItemDialogWidget extends StatefulWidget {
  const DeleteCartItemDialogWidget({
    super.key,
  ...
  State<DeleteCartItemDialogWidget> createState() =>
      _DeleteCartItemDialogWidgetState();
}

class _DeleteCartItemDialogWidgetState
    extends State<DeleteCartItemDialogWidget> {
  late DeleteCartItemDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteCartItemDialogModel());
