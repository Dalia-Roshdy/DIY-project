...
class MotorPartCardDTOStruct extends FFFirebaseStruct {
  MotorPartCardDTOStruct({
    /// item id
  ...
  static MotorPartCardDTOStruct fromMap(Map<String, dynamic> data) =>
      MotorPartCardDTOStruct(
  ...
  static MotorPartCardDTOStruct? maybeFromMap(dynamic data) => data is Map
      ? MotorPartCardDTOStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MotorPartCardDTOStruct fromSerializableMap(
  ...
  @override
  String toString() => 'MotorPartCardDTOStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is MotorPartCardDTOStruct &&
        id == other.id &&
        type == other.type &&
        title == other.title &&
        desc == other.desc &&
...
MotorPartCardDTOStruct createMotorPartCardDTOStruct({
  DocumentReference? id,
  String? type,
  String? title,
  String? desc,
...
MotorPartCardDTOStruct? updateMotorPartCardDTOStruct(
  MotorPartCardDTOStruct? motorPartCardDTO, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    motorPartCardDTO
...
void addMotorPartCardDTOStructData(
  ...
  if (motorPartCardDTO == null) {
    return;
  }
  if (motorPartCardDTO.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && motorPartCardDTO.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final motorPartCardDTOData =
      getMotorPartCardDTOFirestoreData(motorPartCardDTO, forFieldValue);
  final nestedData =
      motorPartCardDTOData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = motorPartCardDTO.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getMotorPartCardDTOFirestoreData(
  MotorPartCardDTOStruct? motorPartCardDTO, [
  bool forFieldValue = false,
]) {
  if (motorPartCardDTO == null) {
  ...
  final firestoreData = mapToFirestore(motorPartCardDTO.toMap());

  // Handle nested data for "motorCard" field.
  addMotorCardStructData(
    firestoreData,
    motorPartCardDTO.hasMotorCard() ? motorPartCardDTO.motorCard : null,
    'motorCard',
    forFieldValue,
  );
  ...
  addCapacitorCardStructData(
    firestoreData,
    motorPartCardDTO.hasCapacitorCard() ? motorPartCardDTO.capacitorCard : null,
    'capacitorCard',
    forFieldValue,
  );
  ...
  addContactorCardStructData(
    firestoreData,
    motorPartCardDTO.hasContactorCard() ? motorPartCardDTO.contactorCard : null,
    'contactorCard',
    forFieldValue,
  );

  // Add any Firestore field values
  mapToFirestore(motorPartCardDTO.firestoreUtilData.fieldValues)
      .forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getMotorPartCardDTOListFirestoreData(
  List<MotorPartCardDTOStruct>? motorPartCardDTOs,
) =>
    motorPartCardDTOs
        ?.map((e) => getMotorPartCardDTOFirestoreData(e, true))
        .toList() ??
    [];
