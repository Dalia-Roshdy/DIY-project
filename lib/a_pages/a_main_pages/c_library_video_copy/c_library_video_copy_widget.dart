...
import 'c_library_video_copy_model.dart';
export 'c_library_video_copy_model.dart';

class CLibraryVideoCopyWidget extends StatefulWidget {
  const CLibraryVideoCopyWidget({super.key});

  static String routeName = 'C-Library_videoCopy';
  static String routePath = '/cLibraryVideoCopy';

  @override
  State<CLibraryVideoCopyWidget> createState() =>
      _CLibraryVideoCopyWidgetState();
}

class _CLibraryVideoCopyWidgetState extends State<CLibraryVideoCopyWidget> {
  late CLibraryVideoCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CLibraryVideoCopyModel());
