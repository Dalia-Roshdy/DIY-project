...
class LShippingAddressEditWidget extends StatefulWidget {
  const LShippingAddressEditWidget({super.key});

  static String routeName = 'L-Shipping_address_edit';
  static String routePath = '/lShippingAddressEdit';

  @override
  State<LShippingAddressEditWidget> createState() =>
      _LShippingAddressEditWidgetState();
}

class _LShippingAddressEditWidgetState
    extends State<LShippingAddressEditWidget> {
  late LShippingAddressEditModel _model;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      wrapWithModel(
                                        model:
                                            _model.lShippingAddressDesktopModel,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: LShippingAddressDesktopWidget(),
                                      ),
                                    if (responsiveVisibility(
                                      context: context,
                                      phone: false,
                                      ...
                                      wrapWithModel(
                                        model: _model.lShippingaddress02Model,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: LShippingaddress02Widget(),
                                      ),
                                    Container(
                                      width: double.infinity,
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      wrapWithModel(
                                        ...
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: LShippingAddressMobile02Widget(),
                                      ),
                                  ],
                                ),
                              ),
