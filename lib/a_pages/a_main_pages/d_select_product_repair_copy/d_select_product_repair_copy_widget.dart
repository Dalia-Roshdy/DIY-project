...
import 'd_select_product_repair_copy_model.dart';
export 'd_select_product_repair_copy_model.dart';

class DSelectProductRepairCopyWidget extends StatefulWidget {
  const DSelectProductRepairCopyWidget({
    super.key,
    this.part,
  });
  ...
  static String routeName = 'D-Select_Product_RepairCopy';
  static String routePath = '/productsC';

  @override
  State<DSelectProductRepairCopyWidget> createState() =>
      _DSelectProductRepairCopyWidgetState();
}

class _DSelectProductRepairCopyWidgetState
    extends State<DSelectProductRepairCopyWidget> {
  late DSelectProductRepairCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DSelectProductRepairCopyModel());
