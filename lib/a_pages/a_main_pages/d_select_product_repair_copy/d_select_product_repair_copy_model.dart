...
import 'd_select_product_repair_copy_widget.dart'
    show DSelectProductRepairCopyWidget;
import 'package:flutter/material.dart';

class DSelectProductRepairCopyModel
    extends FlutterFlowModel<DSelectProductRepairCopyWidget> {
  ...
  // Stores action output result for [Custom Action - filterMotorItems] action in D-Select_Product_RepairCopy widget.
  List<PartCardDTOStruct>? motorItemsOnPageLoad;
  // Stores action output result for [Custom Action - filterContactorItems] action in D-Select_Product_RepairCopy widget.
  List<PartCardDTOStruct>? contOnPageLoad;
  // Stores action output result for [Custom Action - filterCapacitorItems] action in D-Select_Product_RepairCopy widget.
