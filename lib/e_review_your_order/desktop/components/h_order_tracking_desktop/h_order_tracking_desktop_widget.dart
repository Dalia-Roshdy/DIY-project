                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: dateTimeFormat(
                                        "yMMMd", _model.orderDCS!.createdAt!),
                                    style: TextStyle(),
                                  ),
                                  TextSpan(
                                    text: '         -         ',
                                  ...
                                  TextSpan(
                                    text: dateTimeFormat(
                                        "yMMMd", _model.orderDCS!.updatedAt!),
                                    style: TextStyle(),
                                  )
                                ],
                                style: FlutterFlowTheme.of(context)
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      valueOrDefault<String>(
                                        _model.orderDCS?.customerSnap.name,
                                        'name',
                                      ),
                                      maxLines: 4,
                                      style: FlutterFlowTheme.of(context)
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '\$${valueOrDefault<String>(
                                              _model.orderDCS?.totalsSnap.total
                                                  .toString(),
                                              '74.99',
                                            )}',
                                            style: FlutterFlowTheme.of(context)
