                              ...
                              onTap: () async {
                                ...
                                _model.orderList = await queryOrdersRecordOnce(
                                  queryBuilder: (ordersRecord) => ordersRecord
                                      .where(
                                        'customerSnap.email',
                                        isEqualTo: _model.textFieldModel1
                                            .inputTextController.text,
                                      )
                                      .where(
                                        'customerSnap.phone',
                                        isEqualTo: _model.textFieldModel2
                                            .inputTextController.text,
                                      )
                                      .where(
                                        'customerSnap.PIN',
                                        isEqualTo: _model.textFieldModel3
                                            .inputTextController.text,
                                      )
                                ...
                                itemBuilder: (context, ordersListIndex) {
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: OrderCardWidget(
                                      ...
                                      date: dateTimeFormat(
                                          "yMMMd", ordersListItem.createdAt),
                                      iconName: Icon(
                                      ...
                                      items: ordersListItem.payment.amountTotal
                                          .toString(),
