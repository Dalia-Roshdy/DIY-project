...
import 'i_about_mobile02_model.dart';
export 'i_about_mobile02_model.dart';

class IAboutMobile02Widget extends StatefulWidget {
  const IAboutMobile02Widget({super.key});

  static String routeName = 'I-About_mobile_02';
  static String routePath = '/iAboutMobile02';

  @override
  State<IAboutMobile02Widget> createState() => _IAboutMobile02WidgetState();
}

class _IAboutMobile02WidgetState extends State<IAboutMobile02Widget> {
  late IAboutMobile02Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IAboutMobile02Model());
