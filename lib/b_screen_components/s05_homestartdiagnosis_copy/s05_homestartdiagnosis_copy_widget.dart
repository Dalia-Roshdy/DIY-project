...
import 's05_homestartdiagnosis_copy_model.dart';
export 's05_homestartdiagnosis_copy_model.dart';

class S05HomestartdiagnosisCopyWidget extends StatefulWidget {
  const S05HomestartdiagnosisCopyWidget({super.key});

  @override
  State<S05HomestartdiagnosisCopyWidget> createState() =>
      _S05HomestartdiagnosisCopyWidgetState();
}

class _S05HomestartdiagnosisCopyWidgetState
    extends State<S05HomestartdiagnosisCopyWidget>
    with TickerProviderStateMixin {
  late S05HomestartdiagnosisCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S05HomestartdiagnosisCopyModel());
