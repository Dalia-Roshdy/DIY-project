...
import 's05_homestartdiagnosis_copy2_model.dart';
export 's05_homestartdiagnosis_copy2_model.dart';

class S05HomestartdiagnosisCopy2Widget extends StatefulWidget {
  const S05HomestartdiagnosisCopy2Widget({super.key});

  @override
  State<S05HomestartdiagnosisCopy2Widget> createState() =>
      _S05HomestartdiagnosisCopy2WidgetState();
}

class _S05HomestartdiagnosisCopy2WidgetState
    extends State<S05HomestartdiagnosisCopy2Widget>
    with TickerProviderStateMixin {
  late S05HomestartdiagnosisCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S05HomestartdiagnosisCopy2Model());
                              ...
                              child: Column(
                                ...
                                children: [
                                                            ...
                                                            child:
                                                              ...
                                                              controller: _model
                                                                  ...
                                                                  FormFieldController<
                                                                      String>(
                                                                _model
                                                                    .dropDownMakeValue ??= FFAppState().userAC.acMake?.id !=
                                                                            null &&
                                                                        FFAppState().userAC.acMake?.id !=
                                                                            ''
                                                                    ? FFAppState()
                                  ...
                                  if (_model.newAC)
                                    wrapWithModel(
                                      model:
                                          _model.enterManuallySerialNumberModel,
