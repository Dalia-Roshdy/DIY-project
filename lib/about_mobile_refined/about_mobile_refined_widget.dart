...
import 'about_mobile_refined_model.dart';
export 'about_mobile_refined_model.dart';

class AboutMobileRefinedWidget extends StatefulWidget {
  const AboutMobileRefinedWidget({super.key});

  static String routeName = 'AboutMobileRefined';
  static String routePath = '/aboutMobileRefined';

  @override
  State<AboutMobileRefinedWidget> createState() =>
      _AboutMobileRefinedWidgetState();
}

class _AboutMobileRefinedWidgetState extends State<AboutMobileRefinedWidget> {
  late AboutMobileRefinedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AboutMobileRefinedModel());
