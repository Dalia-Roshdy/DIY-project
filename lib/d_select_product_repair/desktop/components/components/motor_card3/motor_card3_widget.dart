...
import 'motor_card3_model.dart';
export 'motor_card3_model.dart';

class MotorCard3Widget extends StatefulWidget {
  const MotorCard3Widget({
    super.key,
    String? img_desc,
    String? price,
    String? rpm,
  ...
  @override
  State<MotorCard3Widget> createState() => _MotorCard3WidgetState();
}

class _MotorCard3WidgetState extends State<MotorCard3Widget> {
  late MotorCard3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MotorCard3Model());
