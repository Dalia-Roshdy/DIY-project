...
import 'select_motor2_model.dart';
export 'select_motor2_model.dart';

class SelectMotor2Widget extends StatefulWidget {
  const SelectMotor2Widget({super.key});

  static String routeName = 'SelectMotor2';
  static String routePath = '/selectMotor2';

  @override
  State<SelectMotor2Widget> createState() => _SelectMotor2WidgetState();
}

class _SelectMotor2WidgetState extends State<SelectMotor2Widget> {
  late SelectMotor2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectMotor2Model());
