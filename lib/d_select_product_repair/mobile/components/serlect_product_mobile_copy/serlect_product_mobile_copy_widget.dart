...
import 'serlect_product_mobile_copy_model.dart';
export 'serlect_product_mobile_copy_model.dart';

class SerlectProductMobileCopyWidget extends StatefulWidget {
  const SerlectProductMobileCopyWidget({
    super.key,
  ...
  @override
  State<SerlectProductMobileCopyWidget> createState() =>
      _SerlectProductMobileCopyWidgetState();
}

class _SerlectProductMobileCopyWidgetState
    extends State<SerlectProductMobileCopyWidget> {
  late SerlectProductMobileCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SerlectProductMobileCopyModel());
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, listIndex) {
                        ...
                        return ProductCard2Widget(
                          key: Key('Keyiet_${listIndex}_of_${list.length}'),
