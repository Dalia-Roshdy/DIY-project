...
import 'serlect_product_mobile_copy_widget.dart'
    show SerlectProductMobileCopyWidget;
import 'package:flutter/material.dart';

class SerlectProductMobileCopyModel
    extends FlutterFlowModel<SerlectProductMobileCopyWidget> {
  ...
  // Stores action output result for [Custom Action - filterMotorItems] action in Serlect_Product_MobileCopy widget.
  List<PartCardDTOStruct>? motorItemsOnPageMob;
  // Stores action output result for [Custom Action - filterContactorItems] action in Serlect_Product_MobileCopy widget.
  List<PartCardDTOStruct>? contItemsOnPageMob;
  // Stores action output result for [Custom Action - filterCapacitorItems] action in Serlect_Product_MobileCopy widget.
