...
import 'text_field18_model.dart';
export 'text_field18_model.dart';

class TextField18Widget extends StatefulWidget {
  const TextField18Widget({
    super.key,
    String? label,
    bool? labelPresent,
    String? helper,
  ...
  @override
  State<TextField18Widget> createState() => _TextField18WidgetState();
}

class _TextField18WidgetState extends State<TextField18Widget> {
  late TextField18Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField18Model());
