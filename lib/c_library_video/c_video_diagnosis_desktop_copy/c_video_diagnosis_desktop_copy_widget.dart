...
import 'c_video_diagnosis_desktop_copy_model.dart';
export 'c_video_diagnosis_desktop_copy_model.dart';

class CVideoDiagnosisDesktopCopyWidget extends StatefulWidget {
  const CVideoDiagnosisDesktopCopyWidget({
    super.key,
  ...
  @override
  State<CVideoDiagnosisDesktopCopyWidget> createState() =>
      _CVideoDiagnosisDesktopCopyWidgetState();
}

class _CVideoDiagnosisDesktopCopyWidgetState
    extends State<CVideoDiagnosisDesktopCopyWidget> {
  late CVideoDiagnosisDesktopCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CVideoDiagnosisDesktopCopyModel());
