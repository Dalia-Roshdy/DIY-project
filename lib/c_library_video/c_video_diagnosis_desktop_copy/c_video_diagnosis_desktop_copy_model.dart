...
import 'c_video_diagnosis_desktop_copy_widget.dart'
    show CVideoDiagnosisDesktopCopyWidget;
import 'package:flutter/material.dart';

class CVideoDiagnosisDesktopCopyModel
    extends FlutterFlowModel<CVideoDiagnosisDesktopCopyWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in C_Video_Diagnosis_desktopCopy widget.
