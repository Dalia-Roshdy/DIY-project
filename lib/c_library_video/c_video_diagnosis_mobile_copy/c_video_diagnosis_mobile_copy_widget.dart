...
import 'c_video_diagnosis_mobile_copy_model.dart';
export 'c_video_diagnosis_mobile_copy_model.dart';

class CVideoDiagnosisMobileCopyWidget extends StatefulWidget {
  const CVideoDiagnosisMobileCopyWidget({
    super.key,
  ...
  @override
  State<CVideoDiagnosisMobileCopyWidget> createState() =>
      _CVideoDiagnosisMobileCopyWidgetState();
}

class _CVideoDiagnosisMobileCopyWidgetState
    extends State<CVideoDiagnosisMobileCopyWidget> {
  late CVideoDiagnosisMobileCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CVideoDiagnosisMobileCopyModel());
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(2.0, 24.0, 0.0, 24.0),
                      child: Row(
